...
Welcome to `soda-model` contributor's guide.
...
If you experience bugs or general issues with `soda-model`, please have a look
...
You can help improve `soda-model` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`soda-model` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `soda-model`'s files. While this mechanism can
...
```
conda create -n soda-model python=3 six virtualenv pytest pytest-cov
conda activate soda-model
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/soda-model.git
   cd soda-model
   ```
...
5. Install [pre-commit]:
   ...
   `soda-model` comes with a lot of hooks configured to automatically help the
